...
std::string Session::ToString() const
{
    ...
    tmp = "sess_id="      + TypeCast<std::string>(base_type::sess_id()) + 
          ", sess_type="  + TypeCast<std::string>(base_type::sess_type()) +
          ", sess_state=" + TypeCast<std::string>(base_type::sess_state()) +
          ", player_uid=" + TypeCast<std::string>(base_type::player_uid());
    return tmp.c_str();
}
