...
LSF_TEST_CASE(test_hex_string)
{
    uint8_t content[] = {
        ...
        0x16, 0x82, 0x00, 0xb7, 0x94, 0xaa, 0x94, 0xa1,
        0x16, 0xaa, 0xb7, 0xb7, 0x12, 0xaa, 0xba, 0x94
    };

    LSF_ASSERT(StringExt::BinToHexString(content, sizeof(content)) == "1634a8c01f12129416b8a81212ccc1ba168200b794aa94a116aab7b712aaba94");
    LSF_ASSERT(StringExt::BinToHexString(StringExt::HexStringToBin(StringExt::BinToHexString(content, sizeof(content)))) == 
