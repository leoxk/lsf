...
LSF_TEST_CASE(test_meta) {
    ...
    // get index
    static_assert(index<int, size_t, uint32_t, bool, char, int>::value == 4, "");
    static_assert(index<int, size_t, uint32_t, bool, int, char, char>::value == 3, "");
    static_assert(index<int, int>::value == 0, "");
    static_assert(index<int>::value == 0, "");
